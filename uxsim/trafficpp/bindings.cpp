...
NB_MODULE(uxsim_cpp, m) {
    ...
    nb::class_<World>(m, "World")
        ...
        .def("reset_sim_start_time", &World::reset_sim_start_time)
        ...
        .def_rw("show_progress", &World::show_progress)
        .def_rw("show_progress_deltat_timestep", &World::show_progress_deltat_timestep)
